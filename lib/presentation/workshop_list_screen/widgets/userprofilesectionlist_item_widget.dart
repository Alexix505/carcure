...
class UserprofilesectionlistItemWidget extends StatelessWidget {
  UserprofilesectionlistItemWidget(
    this.userprofilesectionlistItemModelObj, {
    Key? key,
  }) : super(
          key: key,
        );

  UserprofilesectionlistItemModel userprofilesectionlistItemModelObj;
