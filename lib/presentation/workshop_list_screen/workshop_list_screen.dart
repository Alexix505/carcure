import '../workshop_list_screen/widgets/userprofilesectionlist_item_widget.dart';
import 'models/userprofilesectionlist_item_model.dart';
import 'notifier/workshop_list_notifier.dart';
...
class WorkshopListScreen extends ConsumerStatefulWidget {
  ...
  @override
  WorkshopListScreenState createState() => WorkshopListScreenState();
}

class WorkshopListScreenState extends ConsumerState<WorkshopListScreen> {
  @override
          ...
          child: SingleChildScrollView(
            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  _buildWorkshopNearYouGroup(context),
                  SizedBox(height: 7.v),
                  Text(
                  ...
                  _buildUserProfileSectionList(context),
                  SizedBox(height: 26.v),
                  _buildWorkshopListFrame(context),
                ],
              ),
            ),
          ),
  ...
  /// Section Widget
  Widget _buildWorkshopNearYouGroup(BuildContext context) {
    return Container(
      width: 342.h,
  ...
  /// Section Widget
  Widget _buildUserProfileSectionList(BuildContext context) {
    return Consumer(
      builder: (context, ref, _) {
        return GroupedListView<UserprofilesectionlistItemModel, String>(
          shrinkWrap: true,
          stickyHeaderBackgroundColor: Colors.transparent,
          elements: ref
                  .watch(workshopListNotifier)
          ...
          itemBuilder: (context, model) {
            return UserprofilesectionlistItemWidget(
              model,
            );
          },
          separator: SizedBox(
  ...
  /// Section Widget
  Widget _buildWorkshopListFrame(BuildContext context) {
    return Card(
